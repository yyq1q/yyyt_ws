...
communicator_spec = ["implementation_id", "Communicator", 
...
# 
# </rtc-template>
class Communicator(OpenRTM_aist.DataFlowComponentBase):
...
def CommunicatorInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=communicator_spec)
    manager.registerFactory(profile,
                            Communicator,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    CommunicatorInit(manager)
    ...
    # Create a component
    comp = manager.createComponent("Communicator" + args)
